import type { OrionModule } from "@orion/types";

/* ═══════════════════════════════════════════════════════════════════
   Catálogo canônico dos 26 módulos do O.R.I.O.N.
   Frontend e backend lêem daqui — single source of truth.
═══════════════════════════════════════════════════════════════════ */
...
export const ALL_MODULES: readonly OrionModule[] = [
  ...
  { id: "health",   icon: "♡", label: "SAÚDE",         sub: "Sono · Energia · Pausas",           cat: "wellness", hasReal: false },
  { id: "focus",    icon: "◐", label: "FOCO",          sub: "Pomodoro · Flow · Bloqueio",        cat: "wellness", hasReal: false },
  { id: "habit",    icon: "✓", label: "HÁBITOS",       sub: "Streak · Tracking · Coach",         cat: "wellness", hasReal: false },
  { id: "sleep",    icon: "☽", label: "SLEEP",         sub: "Rotina · Qualidade · Relax",        cat: "wellness", hasReal: false },
  { id: "creative", icon: "✦", label: "CRIAÇÃO",       sub: "Ideias · Nomes · Conteúdo",         cat: "create",   hasReal: false },
  { id: "entert",   icon: "▷", label: "MÍDIA",         sub: "Filmes · Animes · Séries",          cat: "create",   hasReal: false },
  { id: "gaming",   icon: "▣", label: "GAMING",        sub: "Deals · Builds · Companion",        cat: "create",   hasReal: false },
...
export const MODULE_CATS: Record<string, { label: string; color: string }> = {
